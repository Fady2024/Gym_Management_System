...
Booking::Booking(int bookingId, const Court& court, const QDateTime& start, const QDateTime& end)
    : m_bookingId(bookingId), m_court(court), m_startTime(start), m_endTime(end) {}
